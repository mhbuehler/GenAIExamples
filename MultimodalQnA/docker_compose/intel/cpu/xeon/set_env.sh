...
export WHISPER_PORT=7062
export WHISPER_MODEL="base"
export MAX_IMAGES=1
export ASR_ENDPOINT=http://$host_ip:$WHISPER_PORT
export ASR_PORT=9092
export ASR_SERVICE_PORT=3002
...
export EMM_BRIDGETOWER_PORT=6022
export EMBEDDING_MODEL_ID="BridgeTower/bridgetower-large-itm-mlm-itc"
export MMEI_EMBEDDING_ENDPOINT="http://${host_ip}:$EMM_BRIDGETOWER_PORT/v1/encode"
export MM_EMBEDDING_PORT_MICROSERVICE=6002

export REDIS_RETRIEVER_PORT=7002

export LVM_PORT=9392
export LLAVA_SERVER_PORT=8392
export LVM_MODEL_ID="llava-hf/llava-1.5-7b-hf"
export LVM_ENDPOINT="http://${host_ip}:${LLAVA_SERVER_PORT}"

export MEGA_SERVICE_PORT=8882
